 ...
 * @author HP
 */
public class ViewTourismAlerts extends javax.swing.JFrame {

    /**
     * Creates new form ViewTourismAlerts
     */
    public ViewTourismAlerts() {
        initComponents();
        loadRecords();
    }
    ...
    private void initComponents() {
        ...
        title2.setText("VIEW TOURISM ALERTS HERE");
    ...
    private void loadRecords() {
        ...
        try {
            File myObj = new File("TourismAlerts.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewTourismAlerts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
