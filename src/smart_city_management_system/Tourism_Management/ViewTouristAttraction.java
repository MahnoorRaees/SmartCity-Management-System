...
public class ViewTouristAttraction extends javax.swing.JFrame {

    public ViewTouristAttraction() {
        initComponents();
        loadRecords();
    }
    ...
    private void initComponents() {
        ...
        Title.setText("VIEW TOURIST ATTRACTION HERE");
    ...
    private void loadRecords() {
        ...
        try {
            File myObj = new File("Tourism.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewTouristAttraction.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
